        ...
        {role === "student" && (
          <>
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("student", "grade", e.target.value)
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("student", "section", e.target.value)
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("student", "academicYear", e.target.value)
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("parent", "password", e.target.value)
              }
            />
          </>
        )}
        ...
        {role === "teacher" && (
          <>
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("teacher", "specialization", e.target.value)
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("teacher", "educationLevel", e.target.value)
              }
            />
            ...
            <select
              ...
              onChange={(e) =>
                handleNestedChange("teacher", "employmentType", e.target.value)
              }
            >
